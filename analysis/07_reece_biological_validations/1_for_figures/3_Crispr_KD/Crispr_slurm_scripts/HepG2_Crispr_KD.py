...
def run_pipeline_single(
    ...
    append_result(final_table, path=f"/project/PlatigLab/users/reece/ENCODE-RNA-Binding-Protein-Network-Modeling/analysis/07_reece_biological_validations/6_SAFB/HepG2_results_{rbp}.csv")
...
if __name__ == "__main__":
    ...
    append_result(
        ...
        path=f"/project/PlatigLab/users/reece/ENCODE-RNA-Binding-Protein-Network-Modeling/"
             f"analysis/07_reece_biological_validations/6_SAFB/HepG2_results_{rbp}.csv"
    )
