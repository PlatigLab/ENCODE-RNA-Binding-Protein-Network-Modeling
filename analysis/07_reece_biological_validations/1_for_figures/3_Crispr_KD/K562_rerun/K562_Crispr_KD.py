...
def run_pipeline_single(
    ...
    write_result(final_table, path=f"/project/PlatigLab/users/reece/ENCODE-RNA-Binding-Protein-Network-Modeling/analysis/07_reece_biological_validations/1_for_figures/3_Crispr_KD/K562_rerun/rerun_K562_results_{rbp}.csv")
...
if __name__ == "__main__":
    ...
    write_result(
        ...
        path=f"/project/PlatigLab/users/reece/ENCODE-RNA-Binding-Protein-Network-Modeling/"
             f"analysis/07_reece_biological_validations/1_for_figures/3_Crispr_KD/K562_rerun/rerun_K562_results_{rbp}.csv"
    )
