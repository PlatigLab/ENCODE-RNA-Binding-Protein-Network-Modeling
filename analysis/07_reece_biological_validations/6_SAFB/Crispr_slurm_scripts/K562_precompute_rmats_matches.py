...
from Old.K562_Crispr_KD_2 import get_path, load_rmats

RBPS = [
    "NIPBL","SAFB","NOLC1","ZC3H11A","EXOSC5","FXR2","RPS3","ZNF800",
    ...
    "RNF187","SF3B1","GARS","YWHAG"
]

OUT_DIR = Path("precomputed_rmats")
